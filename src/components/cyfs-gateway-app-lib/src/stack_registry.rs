...
pub(crate) fn register_core_gateway_stacks(
    ...
    builder.register(GatewayStackRegistration::new(
        ...
        |runtime: &GatewayStackRuntime| {
            Ok(
                Arc::new(TcpStackFactory::new(runtime.connection_manager.clone()))
    ...
    builder.register(GatewayStackRegistration::new(
        ...
        |runtime: &GatewayStackRuntime| {
            Ok(
                Arc::new(UdpStackFactory::new(runtime.connection_manager.clone()))
                    as Arc<dyn StackFactory>,
            )
        },
        |runtime: &GatewayStackRuntime| {
    ...
    builder.register(GatewayStackRegistration::new(
        ...
        |runtime: &GatewayStackRuntime| {
            Ok(
                Arc::new(RtcpStackFactory::new(runtime.connection_manager.clone()))
                    as Arc<dyn StackFactory>,
            )
        },
        |runtime: &GatewayStackRuntime| {
    ...
    builder.register(GatewayStackRegistration::new(
        ...
        |runtime: &GatewayStackRuntime| {
            Ok(
                Arc::new(TlsStackFactory::new(runtime.connection_manager.clone()))
                    as Arc<dyn StackFactory>,
            )
        },
        |runtime: &GatewayStackRuntime| {
    ...
    builder.register(GatewayStackRegistration::new(
        ...
        |runtime: &GatewayStackRuntime| {
            Ok(
                Arc::new(QuicStackFactory::new(runtime.connection_manager.clone()))
                    as Arc<dyn StackFactory>,
            )
        },
        |runtime: &GatewayStackRuntime| {
